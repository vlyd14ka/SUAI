...
const express = require('express'); // Для работы с сервером Express
...
const storage = multer.diskStorage({
    destination: (req, file, cb) => {
        ...
        cb(null, uploadPath); // Путь к папке для загрузки
    },
...
// Настройка multer с проверкой типа и размера файла
const upload = multer({
    storage: storage,
    limits: { fileSize: 200000 }, // Максимальный размер файла - 200 кб
...
app.post('/register', (req, res) => {
    upload(req, res, (err) => {
        ...
        // Проверка минимального размера файла (100 кб)
        ...
        res.send(`
            ...
            <head>
                ...
                <link rel="stylesheet" href="2.1.css"> <!-- Ссылка на файл стилей -->
            </head>
            <body>
                <div class="container">
